<html>
<head>
<title>Students Control Panel</title>
...
<body>
<p align="center" class="fontheader"><strong>Students
...
<tbody>
        <tr  BgColor="#FFFFE1">
          <td height="40" class="fontnormal">&nbsp;&nbsp;&nbsp;&nbsp;Students Data</td>
        ...
        <tr  BgColor="#FFFFE1">
          <td height="40" class="fontnormal">&nbsp;&nbsp;&nbsp;&nbsp;Find Students</td>
        ...
        <tr  BgColor="#FFFFE1">
          <td height="40" class="fontnormal">&nbsp;&nbsp;&nbsp;&nbsp;Add Students</td>
