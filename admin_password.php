...
<Form name="qs_password_form" method="post" action="clear.php" onSubmit="return qsFormOnSubmitController(this)"  onReset="return qsPageOnResetController(this)" >
<?php
...
?>
<tr>
<td align=Center bgcolor="#FFFFFF" class="button">PLEASE ENTER UNLOCK CODE</td>
</tr>
<tr>
<td class="TrOdd"><input type="text" name="pass"  size="40"></td>
</tr>
<tr>
...
<input name="QS_Submit" type="submit" class="button" value="Submot">&nbsp;&nbsp;
