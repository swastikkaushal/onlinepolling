...
//			echo $_SESSION[$rj['position']];
		...
		$category = $_GET['cat'];
		$button = "<input name=\"vote\" type=\"submit\" id=\"vote\" value=\"SAVE\" class=\"button\">";
		} 
  ...
  echo $r2['name'] ?>
          ...
          <tr>
            <th nowrap scope="row"> <input name="cat" type="hidden" class="button" value="<?php echo $category ?>">
              <?php echo $button ?><input name="close" type="submit" class="button" onClick="MM_goToURL('parent','category.php');return document.MM_returnValue" value="BACK">
