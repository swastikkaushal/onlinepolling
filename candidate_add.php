...
/*************************
			...
			$sy=$_POST['sy'];
$Query="INSERT INTO candidate (id,Name,position,name,platform,picture,sy) VALUES ( '$id','$position','$name','$platform','$picture','$sy');"; 
*******************************/
...
<td class="ThRows">Picture</td>
  ...
  <?php  $cellvalue = "<input $disable type=\"file\" name=\"upload_fd4\">";
;
    if ($cellvalue == "") {
        $cellvalue = "&nbsp;";
    }
...
<input type="hidden" name="act" value="n" class="button" >
...
<input name="QS_Reset" type="reset" class="button" value="Reset"></td>
</tr>
</Table>
<br>
</Form>
