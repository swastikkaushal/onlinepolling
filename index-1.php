...
<p style="text-align:center; color:#60B7DE;"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Please 
...
<td class="TrOdd" align=Default><input name="User" type="text" size="22"></td>
</tr>
<tr>
<td class="ThRows">Password:</td>
<td class="TrOdd" align=Default><input name="Password" type="password" size="24"></td>
</tr>
<tr>
<td class="ThRows">&nbsp;</td>
<td class="TrOdd" align=Default>
<input type="hidden" name="act" value="n">
<input name="QS_Submit" type="submit" class="ThRows" value="Submit">&nbsp;&nbsp;
<input name="Reset" type="reset" class="ThRows" value="Reset">
</td>
</tr>
</Table><br>
